...
function printRecharge(id) {
    ...
    const reportToolsURL = new URL("js/report-tools.js", location.href).href;
...
<script src="${reportToolsURL}"></script>
...
<button
        class="mt-png-btn"
        onclick="MahmudReportTools.downloadPNG('.receipt','Mahmud_Telecom_Recharge_Receipt')"
        type="button">
